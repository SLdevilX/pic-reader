...
if($msg == "/start" or $msg == "/start@picreaderbot"){
Alvi('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"***Hey   $first_name,
...
'inline_keyboard' => [
[['text' => "SUPPORT Chat",'url' => "https://telegram.me/danuma01"],['text' => "CREATOR", 'url' => "https://lasiya.ml"]],
[['text' => "ADD ME", 'url' => "https://telegram.me/$BOT_USERNAME?startgroup=False"],['text' => "Bot news", 'url' => "https://github.com/Benchamxd/Dbotai"]], 
]])
]);
}
?>
